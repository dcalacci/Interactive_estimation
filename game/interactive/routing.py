...
from .consumers import data_broadcast, follow_list, initial_submit, interactive_submit, round_outcome, start_submit
...
game_routes = [
    ...
    route('game.route', start_submit, action='^start_interactive$'),
